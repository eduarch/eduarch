...
<div class="row">
	<div class="medium-12 medium-centered boxed columns">
		<h4><strong>Create Course</strong></h4>
		<hr>
		
		<div class="row">
			<div class="medium-4 columns text-center">
				<div class="show-for-medium show-for-small" style="background: black; color: white; text-align: right; height: 40px; padding: 10px 20px 10px 10px">Course Image</div><br class="show-for-small-only">
				...
				<form action="upload_avatar" method="post" accept-charset="utf-8" enctype="multipart/form-data">
					...
					<button class="tiny radius">
						<i class="glyphicon glyphicon-upload"></i> Upload Course Image
					</button>
			...
			<div class="medium-8 columns hr-flatten">
				<div style="background: black; color: white; text-align: right; height: 40px; padding: 10px 20px 10px 10px">Course Information</div><br>
			   <div class="large-12 columns">
					<label class="label" for="class_name">Course Name</label>
				 ...
				 <div class="large-12 columns">
				 	  <label class="label" for="class_desc">Course Description</label>
				      <textarea id="class_desc" placeholder="Description here " style="height:150px;"></textarea>
				 </div>

					<button type="submit" class="tiny radius"><i class="glyphicon glyphicon-save"></i> Create Course</button>
