<form action="sign_up" method="post" accept-charset="utf-8" class="boxed sticky-label">
	...
	<div class="row">
		<div class="large-6 columns">
			...
			<input type="text" name="user[first_name]" id="first_name" placeholder="50 Characters Maximum" maxlength="50" autocomplete="off" required autofocus
				value="<?php echo set_value('user[first_name]', '') ?>">
		</div>
		<div class="large-6 columns">
			<label class="label" for="last_name">Last Name</label>
			<input type="text" name="user[last_name]" id="last_name" placeholder="50 Characters Maximum" maxlength="50" autocomplete="off" required
	...
	<div class="row"><div class="medium-8 columns left">
		...
		<input type="email" name="user[email]" id="email" placeholder="40 Characters Maximum" maxlength="40" autocomplete="off" required
	...
	<div class="row"><div class="medium-8 columns left">
		...
		<input type="password" name="confirm_password" id="confirm_password" placeholder="5 - 32 Characters" maxlength="32" pattern=".{5,32}" required>
	</div></div>
